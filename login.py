...
def login_for_accsess_token(form_data:OAuth2PasswordRequestForm=Depends(),db: Session = Depends(get_db)):
    ...
    # else:
    #     raise HTTPException(status_code=401,detail='Only active users can login')
